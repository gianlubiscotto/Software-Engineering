...
public:
	 ...
	 * @details	First it performs the conversion from hypro::Box passed as parameter to BR and then it uses it as DAG::cover(const BR< R >& box, N i) const does.
	 ...
	 * @details	First it performs the conversion from hypro::Box passed as parameter to BR and then it uses it as DAG::make(const BR< R >& box) does.
